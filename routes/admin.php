    ...
    Route::middleware(['admin.auth'])->group(function () {
        ...
        Route::prefix('users')->name('users.')->group(function () {
            ...
            Route::middleware('demo.mode')->group(function(){
                Route::post('action', [UserController::class, 'bulkAction'])->name('action');
                Route::get('email', [UserController::class, 'bulkEmail'])->name('email');
                Route::post('email', [UserController::class, 'bulkEmailValidate'])->name('email-validate');
            });
        });
        ...
        Route::prefix('settings')->name('settings.')->group(function () {
            ...
            Route::middleware('demo.mode')->group(function () {
                ...
                Route::post('manual-wallet', [SettingController::class, 'manualWallet'])->name('manual-wallet');
