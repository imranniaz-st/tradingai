...
<body class="ts-gray-1 p-2 md:p-10">
        ...
        <div class="w-full flex justify-between items-center">
            ...
            <div class="relative inline-block">
                ...
                <button
                    ...
                    data-menu-id="1">
                    <span class="">
                        <img src="{{ asset('storage/profile/' . admin()->photo) }}" class="w-8 h-8" alt="Profile">
                    </span>
                ...
                <div class="dropdown-menu hidden absolute right-0 z-20 w-44 py-2 mt-2 overflow-hidden ts-gray-3 rounded-md shadow-xl dark:bg-gray-800 the-menu"
                    ...
                    <div class="w-full flex items-center justify-center text-white p-2 text-center">
                        <p
                            ...
                            <span class="text-white">Hi {{ admin()->name ?? 'Admin' }}</span>
    ...
    <div class="min-h-screen w-full md:flex text-[#ebedf2] mt-28 sm:mt-25">
        <div class="sm:hidden z-40 ts-gray-2 rounded-lg p-3 fixed top-0 left-0 bottom-0 md:mt-36 ml-10 text-sm  min-h-screen w-64 2xl:w-1/5 space-y-3 md:space-y-6 2xl:space-y-8"
            ...
            <div class="w-3/4 mt-3">
                <a href="{{ route('admin.dashboard') }}"
                    class="w-full flex items-center space-x-2 px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.dashboard')) ts-gray-1 @endif">
            ...
            <div class="w-3/4 mt-3">
                <a href="{{ route('admin.users.index') }}"
                    class="w-full flex items-center space-x-2 px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.users.*')) ts-gray-1 @endif">
            ...
            <div class="w-3/4 mt-3">
                <a href="{{ route('admin.kyc.index') }}"
                    class="w-full flex items-center space-x-2 px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.kyc.*')) ts-gray-1 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4" viewBox="0 0 16 16">
                        <path
            ...
            <div class="w-3/4">
                <a href="{{ route('admin.binance.index') }}"
                    class="w-full flex items-center space-x-2  px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.binance.index')) ts-gray-1 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor" class="bi bi-robot"
                        viewBox="0 0 16 16">
                        <path
                            d="M6 12.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5ZM3 8.062C3 6.76 4.235 5.765 5.53 5.886a26.58 26.58 0 0 0 4.94 0C11.765 5.765 13 6.76 13 8.062v1.157a.933.933 0 0 1-.765.935c-.845.147-2.34.346-4.235.346-1.895 0-3.39-.2-4.235-.346A.933.933 0 0 1 3 9.219V8.062Zm4.542-.827a.25.25 0 0 0-.217.068l-.92.9a24.767 24.767 0 0 1-1.871-.183.25.25 0 0 0-.068.495c.55.076 1.232.149 2.02.193a.25.25 0 0 0 .189-.071l.754-.736.847 1.71a.25.25 0 0 0 .404.062l.932-.97a25.286 25.286 0 0 0 1.922-.188.25.25 0 0 0-.068-.495c-.538.074-1.207.145-1.98.189a.25.25 0 0 0-.166.076l-.754.785-.842-1.7a.25.25 0 0 0-.182-.135Z" />
                    ...
                    <span>Binance Plugin</span>
                </a>
            </div>

            <div class="w-3/4">
                <a href="{{ route('admin.settings.templates.index') }}"
                    class="w-full flex items-center space-x-2  px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.settings.templates.*')) ts-gray-1 @endif">
                    {{-- <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor" class="bi bi-robot"
                        viewBox="0 0 16 16">
                        <path
                            d="M6 12.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5ZM3 8.062C3 6.76 4.235 5.765 5.53 5.886a26.58 26.58 0 0 0 4.94 0C11.765 5.765 13 6.76 13 8.062v1.157a.933.933 0 0 1-.765.935c-.845.147-2.34.346-4.235.346-1.895 0-3.39-.2-4.235-.346A.933.933 0 0 1 3 9.219V8.062Zm4.542-.827a.25.25 0 0 0-.217.068l-.92.9a24.767 24.767 0 0 1-1.871-.183.25.25 0 0 0-.068.495c.55.076 1.232.149 2.02.193a.25.25 0 0 0 .189-.071l.754-.736.847 1.71a.25.25 0 0 0 .404.062l.932-.97a25.286 25.286 0 0 0 1.922-.188.25.25 0 0 0-.068-.495c-.538.074-1.207.145-1.98.189a.25.25 0 0 0-.166.076l-.754.785-.842-1.7a.25.25 0 0 0-.182-.135Z" />
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor"
                        class="bi bi-file-earmark-break-fill" viewBox="0 0 16 16">
                        <path
            ...
            <div class="w-3/4">
                <a href="{{ route('admin.transfers.index') }}"
                    class="w-full flex items-center space-x-2  px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.transfers.index')) ts-gray-1 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                        <path fill-rule="evenodd"
            ...
            <div class="w-3/4">
                <a href="{{ route('admin.transactions.index') }}"
                    class="w-full flex items-center space-x-2  px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.transactions.*')) ts-gray-1 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                        <path fill-rule="evenodd"
            ...
            <div class="w-3/4">
                <a href="{{ route('admin.pages.index') }}"
                    class="w-full flex items-center space-x-2  px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.pages.*')) ts-gray-1 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4" viewBox="0 0 16 16">
                        <path
            ...
            <div class="w-3/4">
                <a href="{{ route('admin.settings.index') }}"
                    class="w-full flex items-center space-x-2  px-3 py-1 rounded-full shadow hover:text-purple-700 hover:scale-110 transition-all @if (request()->routeIs('admin.settings.*')) ts-gray-1 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4" viewBox="0 0 16 16">
                        <path
    ...
    <div class="sm:w-100-2 text-white fixed bottom-0 px-2 py-2">
        <div class="dropdown-menu fixed hidden bottom-0 right-0 left-0 mx-5 z-20  py-2 mb-20 overflow-hidden ts-gray-3 rounded  the-menu"
            ...
            <a href="{{ route('admin.settings.templates.index') }}"
                class="block px-4 py-3 text-sm capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                Templates
            </a>
        ...
        <div
            ...
            {{-- Users --}}
            <a href="{{ route('admin.users.index') }}" class="ts-gray-1 rounded-full px-2 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                    <path
            ...
            html = `
                <div class="mt-5 h-72 ts-gray-3 p-2 rounded-lg flex justify-center items-center">
                    <div>
                        ...
                        <form action="{{ route('admin.logout') }}" class="mt-5 gen-form" data-action="redirect" data-url="{{ route('admin.login') }}">
                            @csrf
