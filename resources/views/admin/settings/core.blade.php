            ...
            <form action="{{ route('admin.settings.core') }}" class="mt-5 gen-form" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-5">
                    ...
                    <div class="grid grid-cols-1  gap-5">
                        ...
                        <div class="relative">
                            <input type="number" step="any" name="welcome_bonus" placeholder="Welcome Bonus"
                                id="welcome_bonus" class="theme1-text-input pl-3" required
                                value="{{ site('welcome_bonus') }}">
                            <label for="welcome_bonus" class="placeholder-label text-gray-300 ts-gray-2 px-2">Welcome Bonus
                                ({{ site('currency') }})</label>
                            <span class="text-xs text-red-500">
                                @error('welcome_bonus')
                                    {{ $message }}
